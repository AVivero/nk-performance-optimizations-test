...
urlGraphics:    '/Content/floatbox/graphics/'   ,// change this if you install in another folder
urlLanguages:   '/Content/floatbox/languages/'  ,// change this if you install in another folder
/*** </General Options> ***/
...
//TODO: Refine code... called from CalendarMarket to hook the 9DFC overlay 
function initfb_force(){
	var fbWindow = 'self';
	if (self !== parent) {
		try {
